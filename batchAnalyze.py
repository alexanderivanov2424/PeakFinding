...
#calibPath = os.path.expanduser('/home/b_mehta/data/bl1-5/Nov2018/Oak_Ridge/AM/higher exposure/2deg/calib_25Nov_oak_calib4_2deg.calib')
calibPath = os.path.expanduser('/home/sasha/Desktop/exampleforrobertscode/calib_21Feb_3inch_1deg.calib')
#calibPath = os.path.expanduser('/home/b_mehta/data/bl1-5/Nov2017/CoTaZr/data/9Nov17_calib_5.calib')
...
if calibPath is '':
    ...
    sys.exit()
dataPath = os.path.expanduser('/home/sasha/Desktop/exampleforrobertscode/')
#dataPath = os.path.expanduser('/home/b_mehta/data/bl1-5/Nov2017/CoTaZr/data/J1_s/')
#dataPath = os.path.expanduser('/home/b_mehta/data/bl1-5/Nov2018/Oak_Ridge/Meltspun/high resolution/')
#dataPath = tkFileDialog.askdirectory(title='Select folder to process')
if dataPath is '':
    print('No data folder selected, aborting...')
    sys.exit()

configPath = os.path.expanduser('/home/sasha/Desktop/code_nov-20190618T163823Z-001/code_nov/config')
#configPath = os.path.expanduser('~/code_nov/config')
